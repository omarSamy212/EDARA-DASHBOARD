...
<nav  id ="navv"class="navbar navbar-expand-lg navbar-dark bg-dark" margin-left='70px'>
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
      ...
      <li class="nav-item"> 
          <Link to={"/products"}class="nav-link active" aria-current="page" color="white" >Prouduct</Link>
          </li>
...
<div  id="form" className="Design">
  ...
  <div class="row mb-4">
    ...
    <div class="col">
      <div class="form-outline">
      <label class="form-label" for="form6Example2">Product Id</label>
  ...
  <div class="row mb-4">
    <div class="col">
      <div class="form-outline">
      <label class="form-label" for="form6Example1">Stock</label>
        <input type="text" id="form6Example1" class="form-control" />
