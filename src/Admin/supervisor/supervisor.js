...
<div class="omar90">
<div  class="container py-5 text-white" style={{marginbottom:-75, marginTop:5 }}>
        <div class="row">
                            ...
                            <table class="table m-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                        <Link to={"/addSV"}><button type="button" class="btn btn-warning btn-sm">Update</button></Link>
                                        <button type="button" class="btn btn-danger btn-sm" style={{marginLeft:20}}>Delete</button>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <Link to={"/addSV"}><label class="btn btn-success " for="btnradio1">Add Supervisor</label></Link>
                                    </div>
